...
public class MiniPhantomMenu extends AbstractContainerMenu {
	...
	public MiniPhantomMenu(int id, Inventory playerInventory, FriendlyByteBuf extraData) {
		this(AllMenuTypes.MINI_PHANTOM.get(), id, playerInventory, extraData);
	}

	public MiniPhantomMenu(MenuType<?> type, int id, Inventory playerInventory, FriendlyByteBuf extraData) {
		super(type, id);
	...
	@OnlyIn(Dist.CLIENT)
	public static MiniPhantomMenu createOnClient(int id, Inventory playerInventory, FriendlyByteBuf extraData) {
