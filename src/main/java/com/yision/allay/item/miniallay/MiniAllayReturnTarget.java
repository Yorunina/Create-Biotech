...
public record MiniAllayReturnTarget(ResourceKey<Level> dimension, BlockPos pos) {
	...
	public static Optional<MiniAllayReturnTarget> read(CompoundTag tag) {
		...
		return Optional.of(new MiniAllayReturnTarget(
